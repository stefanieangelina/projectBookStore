...
<body>
    <div id="container">
        ...
        <div id="containerRegist">
            <div id="formRegist" style="padding-top: 50px">
                <h2>Masuk</h2>
                <br>
                <form action="" method="">
                    @csrf
                    ...
                    <!-- cetak error validate-->
                    <br><br>
                    <input type="submit" name="" id="btnRegister" value="Masuk" class="rounded btn btn-outline-danger">
                    <br> 
                    <h6 id="backToLogin">Belum Mendaftar?  <a href="">Daftar</a></h6>
                </form> 
            </div>
            <div id="logoDiv">
